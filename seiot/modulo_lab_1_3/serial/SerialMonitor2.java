...
public class SerialMonitor2 implements SerialPortEventListener {
	...
	public static void main(String[] args) throws Exception {
		/* if (args.length != 2){
			...
			try {
				String comPortName = "/dev/cu.Bluetooth-Incoming-Port"; // args[0];
				int boudRate = 115200; // Integer.parseInt(args[1]);
				// System.out.println("Start monitoring serial port " + args[0]+" at "+ boudRate +" boud rate");
				try {
					SerialMonitor2 monitor = new SerialMonitor2();
